...
var $pid = "${client.emp.part.p_id}";
var $eid = "${client.emp.e_id}";
</script>
		...
		<div class="formbody" style="width: 450px;">
			<ul class="forminfo1">
				...
				<input type="hidden"  id="cid" value="${client.c_id}">
					...
					<input type="text" class="dfinput1 newdefault" id="cname" value="${client.c_name}"
						placeholder="请输入客户姓名">
				</li>
				<li>
					<label>
					...
					<input type="text" class="dfinput1 newdefault" id="ctel" value="${client.c_tel}"
				...
				<li>
					...
					<input type="text" class="dfinput1 newdefault" id="caddress" value="${client.c_address}"
						placeholder="请输入客户地址">
